...
//######################################################################################################################################
//######################################################################################################################################
//core::color::ColorCode::ColorCode()
//{
//	color::ColorCode::COLOR_BLACK			=0x0;
//	color::ColorCode::COLOR_DARKBLUE		=0x1;
//	color::ColorCode::COLOR_DARKGREEN		=0x2;
//	color::ColorCode::COLOR_DARKTURK		=0x3;
//	color::ColorCode::COLOR_DARKRED			=0x4;
//	color::ColorCode::COLOR_LILA			=0x5;
//	color::ColorCode::COLOR_BROWN			=0x6;
//	color::ColorCode::COLOR_GREY			=0x7;
//	color::ColorCode::COLOR_DARKGREY		=0x8;
//	color::ColorCode::COLOR_BLUE			=0x9;
//	color::ColorCode::COLOR_GREEN			=0xA;
//	color::ColorCode::COLOR_TURK			=0xB;
//	color::ColorCode::COLOR_RED				=0xC;
//	color::ColorCode::COLOR_PINK			=0xD;
//	color::ColorCode::COLOR_YELLOW			=0xE;
//	color::ColorCode::COLOR_WHITE			=0xF;
//}
//######################################################################################################################################
//######################################################################################################################################
//######################################################################################################################################
...
//######################################################################################################################################
//######################################################################################################################################
core::CoreAPI::CoreAPI(/*167,66*/short iScreenx,short iScreeny,const char* cConsoleTitle,bool bShowCursor)
{
...
//######################################################################################################################################
//######################################################################################################################################
void core::CoreAPI::StringTextElementCopyBackup(std::string Text, bool visible,std::string* textcopy)
{
	if(visible)
	{
		std::cout << Text << std::endl; 
...
//######################################################################################################################################
//######################################################################################################################################
void core::CoreAPI::setConsoleTitle(const char* ConsoleTitle)
{
...
//##########################################################~1.2.0.3~###################################################################
//######################################################################################################################################
void core::CoreAPI::DrawBoxVec(int x, int y, int w, int h,byte BorderColor,unsigned int size__,std::vector<MenuItem> Items)
{
...
//######################################################################################################################################
/*
void CoreAPI::DrawBoxVec(int x, int y, int w, int h,byte BorderColor,std::vector<MenuItem> Items)
{
